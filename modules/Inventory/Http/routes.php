...
Route::group([
    ...
    Route::get('item-groups/getOptionValues', 'ItemGroups@getOptionValues')->name('item-groups.get-option-values');
    ...
    Route::get('items/{item}', 'Items@show')->name('inventory.items.show');
